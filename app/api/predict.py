...
async def predict_smiles(
    request: SMILESPredictionRequest,
    ...
    try:
        ...
        try:
            descriptors = descriptor_calculator.calculate_cached(processed_mol.canonical_smiles)
        ...
        compound_response = CompoundPredictionResponse(
            ...
            molecular_properties=processed_mol.properties if request.include_properties else None,
...
async def predict_sdf(
    ...
    try:
        ...
        for i, (result, (_, name)) in enumerate(zip(batch_response.results, smiles_list)):
...
async def _process_single_compound(
    ...
    try:
        ...
        compound_response = CompoundPredictionResponse(
            ...
            molecular_formula=processed_mol.molecular_formula,
            predictions=PredictionResults(**api_predictions),
            molecular_properties=processed_mol.properties if include_properties else None,
