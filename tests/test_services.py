...
from app.services.descriptor_calculator import DescriptorCalculator, create_descriptor_calculator
...
class TestChemicalProcessor:
    ...
    def test_process_invalid_smiles(self):
        ...
        assert len(result.errors) > 0
        assert "Invalid SMILES" in result.errors[0] or "processing" in result.errors[0].lower()
    ...
    def test_full_prediction_workflow(self):
        ...
        try:
            ...
            result = predictor.predict(
                ...
                smiles=processed.canonical_smiles
            )
